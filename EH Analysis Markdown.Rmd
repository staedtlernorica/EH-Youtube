...
```{r basic stuff}
setwd("C:/Users/longv/Documents/GitHub/EH-Youtube")
...
dp <- ggplot(eh, aes(x = views, y = fct_reorder(series,seriesNo, .desc = TRUE), color = (as.numeric(year) %% 2 == 0))) + 
  ...
  theme(axis.text.y = element_text(angle = 0, vjust = 0.25)) + 
  labs(title = "Extra History's Series Viewership, Organized by Series' Upload Order\n", x = "Views", y = "Series' Name", color = "Year\n") +
